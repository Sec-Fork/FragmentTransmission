...
public class GenerateBlockClassTmpPlugin implements IHelper{
    @Override
    public String getHelperTabCaption() {
        return "GenerateBlockClassToTmp";
    }
    ...
    public void doHelp(Map<String, Object> map, IResultOutput iResultOutput) throws Throwable {
        ...
        iResultOutput.rawPrintln("GenerateBlockClassToTmp Execution completed");
    }
}
